...
\citembe{ka_ks_li_1993} \TODO{reference section in supplemental methods about this. How do ks and ka define positive and negative selection?}.
...
It was significantly more accurate (lower $d_{seq}$) at inferring simulated alignments compared to other methods; all p-values were less than $4.0 \cdot 10^{-06}$ according to the one-tailed, paired Wilcoxon signed-rank tests. \TODO{reference figures in supplement.}
%
