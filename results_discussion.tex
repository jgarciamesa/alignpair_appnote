...
COATi, using the codon-triplet-mg model, was significantly more accurate (lower $d_{seq}$) at inferring simulated alignments compared to other methods; all p-values were less than $2.06 \cdot 10^{-79}$ according to the one-tailed Wilcoxon signed rank test (Supplementary Materials Figure 1).
