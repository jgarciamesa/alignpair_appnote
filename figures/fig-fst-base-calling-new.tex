...
\node[block,right = of start] (s) {S}; 
\node[block,left = of end] (m) {M};
...
\foreach \y [count=\yi] in {
  {A:A/$(1-e)$}, {A:C/$(e/3)$}, {A:G/$(e/3)$}, {A:T/$(e/3)$},
  {C:A/$(e/3)$}, {C:C/$(1-e)$}, {C:G/$(e/3)$}, {C:T/$(e/3)$}
} {
...
\foreach \y [count=\yi] in {
  {G:A/$(e/3)$}, {G:C/$(e/3)$}, {G:G/$(1-e)$}, {G:T/$(e/3)$},
  {T:A/$(e/3)$}, {T:C/$(e/3)$}, {T:G/$(e/3)$}, {T:T/$(1-e)$}
} {
...
\foreach \y [count=\yi] in {
  {A:N/$1$}, {A:A/$(1-e)$}, {A:C/$(e/3)$}, {A:G/$(e/3)$}, {A:T/$(e/3)$},
  {C:N/$1$}, {C:A/$(e/3)$}, {C:C/$(1-e)$}, {C:G/$(e/3)$}, {C:T/$(e/3)$}
} {
...
\foreach \y [count=\yi] in {
  {G:N/$1$}, {G:A/$(e/3)$}, {G:C/$(e/3)$}, {G:G/$(1-e)$}, {G:T/$(e/3)$},
  {T:N/$1$}, {T:A/$(e/3)$}, {T:C/$(e/3)$}, {T:G/$(e/3)$}, {T:T/$(1-e)$}
} {
    \coordinate (y) at ($(mid) + (0, 0.25em) + \yi*(0, -1.75em)$);
    \path[line,shorten <=1em+0.2pt, shorten >=1em+0.3pt] (s.center) to[curve through={(y)}] (m.center);
    \node[lab,anchor=north] at (y) {\y};
