...
\tikzset{
  ...
  block/.style={circle,on grid,fill=colorBu,text=white,minimum width=2em,node distance=4em},
...
\draw[white,line width=2pt] ($(w)!0.245!(i)$) -- +(0,4pt);
\draw[white,line width=2pt] ($(w)!0.385!(i)$) -- +(0,4pt);
\draw[white,line width=2pt] ($(w)!0.525!(i)$) -- +(0,4pt);
\draw[white,line width=2pt] ($(w)!0.665!(i)$) -- +(0,4pt);
...
\draw[line] (s) to[out=225,in=0] (suba) to[out=180,in=350] (m);
\draw[line] (s) to[out=240,in=0] (subc) to[out=180,in=335] (m);
\draw[line] (s) to[out=255,in=0] (subg) to[out=180,in=320] (m);
\draw[line] (s) to[out=270,in=0] (subt) to[out=180,in=305] (m);
